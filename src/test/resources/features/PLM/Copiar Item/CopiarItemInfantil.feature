...
Funcionalidade: Copiar Item Feminino
  ...
  Esquema do Cenario: Copiar Item Feminino
    ...
    E Seleciono view e filtro item infantil para copiar <viewPlm> e <dataIncial>, <dataFinal> <brand>
    E seleciono a view cadastro de item
    E preencho campos obrigatórios view infantil, criado a partir de um existente, informando <estampado>, <bordado>, <tecidotinjido>, <tecidolavavel>, <fiodiferente>, <udamarca>, <origempais>, <udaorigem> e <udanatureza>
    ...
    Exemplos:
      ...
      | "FW24" | "Infantil Menina"     | "LICENCIADOS(A)"  | "Camiseta ML"            |"Cadastro de Itens"  | "01/01/2023" | "27/02/2024"  |     "13-0643 TCX:Yellow Plum"   |    "14-0849 TCX:Beach Ball"  |   "14-4815 TCX:Leisure Time"  | "DDX TEXTIL INDUSTRIA E COMERCIO DE MALHAS LTDA - 0001-39"     | "500"          |        "50"          |    "Não"   |  "Não"  |     "Não"     |     "Sim"      |    "Não"      |  "Pegada"  |  "BRASIL"   |  "Nacional" |"LICENCIADOS"  |  "Royalties" |     "NA"   |"NA"  |"Cotton / Algodão"|
